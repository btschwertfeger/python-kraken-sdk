...
class ManagedBot():
    ...
    async def __main(self) -> None:
        ...
        await self.__trading_strategy.subscribe(feed='ticker', products=self.__config['products'])
        await self.__trading_strategy.subscribe(feed='book', products=self.__config['products'])
