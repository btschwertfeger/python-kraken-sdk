...
class MarketClient(KrakenBaseFuturesAPI):
    ...
    def get_ohlc(
        ...
        """(see: https://docs.futures.kraken.com/#http-api-charts-ohlc-get-ohlc and
    ...
    def get_tick_types(self) -> dict:
        """(see: https://docs.futures.kraken.com/#http-api-charts-ohlc-get-tick-types)"""
        return self._request(method="GET", uri="/api/charts/v1/", auth=False)

    def get_tradeable_products(self, tick_type: str) -> dict:
        """(see: https://docs.futures.kraken.com/#http-api-charts-ohlc-get-tradeable-products)"""
        return self._request(
    ...
    def get_fee_schedules(self) -> dict:
        """(see: https://docs.futures.kraken.com/#http-api-trading-v3-api-fee-schedules-get-fee-schedules and
    ...
    def get_fee_schedules_vol(self) -> dict:
        """(see: https://docs.futures.kraken.com/#http-api-trading-v3-api-fee-schedules-get-fee-schedule-volumes)"""
        return self._request(
            method="GET", uri="/derivatives/api/v3/feeschedules/volumes", auth=True
        )

    def get_orderbook(self, symbol: str = None) -> dict:
        """(see: https://docs.futures.kraken.com/#http-api-trading-v3-api-market-data-get-orderbook and
    ...
    def get_tickers(self) -> dict:
        """(see: https://docs.futures.kraken.com/#http-api-trading-v3-api-market-data-get-tickers and
    ...
    def get_instruments(self) -> dict:
        """(see: https://docs.futures.kraken.com/#http-api-trading-v3-api-instrument-details-get-instruments and
    ...
    def get_instruments_status(self, instrument: str = None) -> dict:
        """(see: https://docs.futures.kraken.com/#http-api-trading-v3-api-instrument-details-get-instrument-status-list and
    ...
    def get_trade_history(
        ...
        """(see: https://docs.futures.kraken.com/#http-api-trading-v3-api-market-data-get-trade-history and
    ...
    def get_historical_funding_rates(self, symbol: str) -> dict:
        """(see: https://support.kraken.com/hc/en-us/articles/360061979852-Historical-Funding-Rates)"""
        return self._request(
            method="GET",
    ...
    def get_order_events(
        ...
        """(see: https://docs.futures.kraken.com/#http-api-history-market-history-get-order-events)"""
        return self._get_historical_events(
    ...
    def get_trigger_events(
        ...
        """(see: https://docs.futures.kraken.com/#http-api-history-market-history-get-trigger-events)"""
        return self._get_historical_events(
