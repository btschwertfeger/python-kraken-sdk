...
class MarketTests(unittest.TestCase):
    ...
    @unittest.skip(
        "Skipping Futures set_leverage_preference endpoint, because this needs full access"
    )
    ...
    @unittest.skip(
        "Skipping Futures set_pnl_preference endpoint, because this needs full access"
    )
