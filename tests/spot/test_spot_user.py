...
class TestSpotUser:
    """Test class for Spot User client functionality."""

    TEST_TXID = "OXBBSK-EUGDR-TDNIEQ"
    TEST_USERREF = "1234567"
    TEST_ASSET_XBT = "XBT"
    TEST_ASSET_EUR = "EUR"
    TEST_ASSET_DOT = "DOT"

    def test_get_account_balance(self: Self, spot_auth_user: User) -> None:
        """
    ...
    def test_get_balances(self: Self, spot_auth_user: User) -> None:
        """
    ...
    def test_get_open_orders(self: Self, spot_auth_user: User) -> None:
        """
    ...
    def test_get_trades_info(self: Self, spot_auth_user: User) -> None:
        """
    ...
    def test_get_orders_info(self: Self, spot_auth_user: User) -> None:
        """
    ...
    def test_get_order_amends(self: Self, spot_auth_user: User) -> None:
        """
        ...
        assert is_not_error(
            spot_auth_user.get_order_amends(order_id="OVM3PT-56ACO-53SM2T"),
        )

    def test_get_trades_history(self: Self, spot_auth_user: User) -> None:
        """
    ...
    def test_get_open_positions(self: Self, spot_auth_user: User) -> None:
        """
    ...
    def test_get_ledgers_info(self: Self, spot_auth_user: User) -> None:
        """
    ...
    def test_get_ledgers(self: Self, spot_auth_user: User) -> None:
        """
    ...
    def test_get_trade_volume(self: Self, spot_auth_user: User) -> None:
        """
    ...
    def test_export_report_status_invalid(self: Self, spot_auth_user: User) -> None:
        """
    ...
    def test_create_subaccount_failing(self: Self, spot_auth_user: User) -> None:
        """
    ...
    def test_account_transfer_failing(self: Self, spot_auth_user: User) -> None:
        """
